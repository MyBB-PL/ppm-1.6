...
$l['postdata_banned_username'] = 'Wybrany login jest nieprawidłowy. Wybierz inny login.';
$l['postdata_bad_characters_username'] = 'Wybrany login zawiera niedozwolone znaki. Wybierz inny login.';
$l['postdata_invalid_username_length'] = 'Wybrany login posiada nieprawidłową długość. Login powinien składać się z od {1} do {2} znaków.';

<?php
/**
 * MyBB 1.6.18 Polish Language Pack
...
$l['bottomlinks_returncontent'] = "Wróć do forów";
...
$l['sticky_prefix'] = "<strong>Przypięty:</strong>";
$l['poll_prefix'] = "Ankieta:";
$l['announcement_prefix'] = "<strong>Ogłoszenie:</strong>";
...
$l['thread_subscription_method'] = "<strong>Subskrypcja wątku:</strong><br /><span class=\"smalltext\">Wybierz sposób subskrypcji tego wątku. (tylko dla zarejestrowanych)</span>";
$l['no_subscribe'] = "Nie subskrybuj wątku";
$l['no_email_subscribe'] = "Subskrybuj wątek, ale nie wysyłaj powiadomień e-mail o nowej odpowiedzi";
...
$l['editor_title_bold'] = "Wprowadź pogrubiony tekst";
$l['editor_title_italic'] = "Wprowadź pochylony tekst";
$l['editor_title_underline'] = "Wprowadź podkreślony tekst";
$l['editor_title_left'] = "Wyrównaj do lewej";
$l['editor_title_center'] = "Wyrównaj do środka";
$l['editor_title_right'] = "Wyrównaj do prawej";
$l['editor_title_justify'] = "Wyjustuj";
$l['editor_title_numlist'] = "Wprowadź listę numerowaną";
$l['editor_title_bulletlist'] = "Wprowadź listę punktowaną";
$l['editor_title_image'] = "Wprowadź obrazek";
$l['editor_title_hyperlink'] = "Wprowadź link";
$l['editor_title_email'] = "Wprowadź adres e-mail";
$l['editor_title_quote'] = "Wprowadź cytowany tekst";
$l['editor_title_code'] = "Wprowadź kod";
$l['editor_title_php'] = "Wprowadź kod PHP";
$l['editor_title_close_tags'] = "Zamknij wszystkie otwarte tagi";
$l['editor_enter_list_item'] = "Wprowadź punkt listy. Kliknij \"Anuluj\" lub pozostaw to pole puste, aby zakończyć listę.";
$l['editor_enter_url'] = "Wprowadź link.";
$l['editor_enter_url_title'] = "Możesz wprowadzić opis dla linku.";
$l['editor_enter_email'] = "Wprowadź adres e-mail.";
$l['editor_enter_email_title'] = "Możesz wprowadzić opis dla adresu e-mail.";
$l['editor_enter_image'] = "Wprowadź adres URL wstawianego obrazka.";
$l['editor_enter_video_url'] = "Wprowadź adres URL wstawianego pliku wideo.";
...
$l['editor_size_xx_small'] = "Najmniejszy";
$l['editor_size_x_small'] = "Bardzo mały";
$l['editor_size_small'] = "Mały";
$l['editor_size_medium'] = "Średni";
$l['editor_size_large'] = "Duży";
$l['editor_size_x_large'] = "Bardzo duży";
$l['editor_size_xx_large'] = "Największy";
$l['editor_font'] = "Czcionka";
$l['editor_size'] = "Rozmiar tekstu";
$l['editor_color'] = "Kolor tekstu";
...
$l['postbit_edited'] = "Ten post był ostatnio modyfikowany: {1} {2} przez";
...
$l['postbit_qdelete'] = "Usuń ten post";
...
$l['newpm_notice_one'] = "<strong>Masz jedną nieprzeczytaną prywatną wiadomość</strong> od {1}, zatytułowaną <a href=\"private.php?action=read&amp;pmid={2}\" style=\"font-weight: bold;\">{3}</a>";
$l['newpm_notice_multiple'] = "<strong>Liczba nowych nieprzeczytanych prywatnych wiadomości: {1}.</strong> Ostatnia z nich to wiadomość od {2}, zatytułowana <a href=\"private.php?action=read&amp;pmid={3}\" style=\"font-weight: bold;\">{4}</a>";
...
$l['timezone_gmt_minus_400'] = "(UTC -4:00) Czas atlantycki (Kanada), Caracas, La Paz";
$l['timezone_gmt_minus_350'] = "(UTC -3:30) Nowa Fundlandia";
...
$l['timezone_gmt_350'] = "(UTC +3:30) Tehran";

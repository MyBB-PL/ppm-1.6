...
$l['setting_group_general_desc'] = "Ustawienia ogólne, m.in. nazwa i adres forum, a także nazwa i adres głównej strony serwisu.";
...
$l['setting_boardclosed_desc'] = "Możesz tutaj zamknąć swoje forum, np. celem przeprowadzenia jakichś prac (aktualizacji itp.). Użytkownicy nie będą mogli przeglądać forum, zobaczą jedynie informację o powodzie zamknięcia, który podasz poniżej.<br />
<br />
<b>Administratorzy będą nadal mogli przeglądać forum.</b>";
...
$l['setting_portal_announcementsfid'] = "ID działu z ogłoszeniami";
$l['setting_portal_announcementsfid_desc'] = "Wpisz ID działu (fid), którego wątki będą wyświetlane jako ogłoszenia. Jeżeli chcesz podać więcej niż jeden taki dział, oddziel numery przecinkami (\",\").";

...
function buildsettings()
{
	...
	{
		$output->print_header("Przebudowywanie ustawień");
		echo "<p><div class=\"error\"><span style=\"color: red; font-weight: bold;\">Błąd: Nie można otworzyć inc/settings.php</span><h3>Przed uruchomieniem procesu aktualizacji sprawdź uprawnienia dostępu dla tego pliku.</h3></div></p>";
		$output->print_footer("rebuildsettings");
		exit;
	}
...
function upgradedone()
{
	...
	ob_start();
	$output->print_header("Aktualizacja zakończona");

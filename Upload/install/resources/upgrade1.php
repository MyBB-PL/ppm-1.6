...
function upgrade1_dbchanges()
{
	...
	$db->write_query("INSERT INTO attachtypes VALUES(NULL,'Archiwum skompresowane','','zip gz tar rar ace cab','1024');");
	$db->write_query("INSERT INTO attachtypes VALUES(NULL,'Obraz JPEG','','jpg jpe jpeg','500');");
	$db->write_query("INSERT INTO attachtypes VALUES(NULL,'Dokument tekstowy','text/plain','txt','200');");
	$db->write_query("INSERT INTO attachtypes VALUES(NULL,'Obraz GIF','image/gif','gif','500');");
	$db->write_query("INSERT INTO attachtypes VALUES(NULL,'Mapa bitowa','','bmp','500');");
	$db->write_query("INSERT INTO attachtypes VALUES(NULL,'Plik PHP','','php phps php3 php4','500');");
	$db->write_query("INSERT INTO attachtypes VALUES(NULL,'Obraz PNG','image/png image/x-png','png','50');");
	$db->write_query("INSERT INTO attachtypes VALUES(NULL,'Dokument Microsoft Word','','doc rtf','1024');");
	$db->write_query("INSERT INTO attachtypes VALUES(NULL,'Plik wykonywalny','','exe com bat','1024');");
	...
	$output->print_contents("$contents<p>Naciœnij przycisk Dalej, aby kontynuowaæ proces aktualizacji.</p>");
...
function upgrade1_dbchanges2()
{
	...
	$output->print_contents("Domyœlny styl zosta³ zaimportowany<p>Naciœnij przycisk Dalej, aby kontynuowaæ proces aktualizacji.</p>");
...
function upgrade1_dbchanges3()
{
	...
	$contents .= "<p>Ponowne tworzenie ustawieñ...";

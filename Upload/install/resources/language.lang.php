...
$l['req_step_error_phpversion'] = 'Minimalna wersja PHP wymagana do instalacji MyBB to 4.1.0 lub nowsza. Posiadasz zainstalowaną wersję {1}.';
...
$l['config_step_table'] = '<p>Skonfiguruj podstawowe ustawienia takie jak nazwa forum, jego adres a także informacje o Twojej stronie. Te ustawienia mogą później zostać łatwo zmienione w panelu administratora (ACP).</p>
		<div class="border_wrapper">
			...
			<table class="general" cellspacing="0">
				...
				<tr>
					<th colspan="2" class="first last">Dane kontaktowe (pokazywane w stopce)</th>
				</tr>
				<tr class="last">
...
$l['done_step_usergroupsinserted'] = "<p>Zaimportowano grupy użytkowników.";
$l['done_step_admincreated'] = '<p>Utworzono konto administratora.';
$l['done_step_adminoptions'] = '<p>Zapisano uprawnienia administratora.';
$l['done_step_cachebuilding'] = '<p>Utworzono pamięć podręczną.';
